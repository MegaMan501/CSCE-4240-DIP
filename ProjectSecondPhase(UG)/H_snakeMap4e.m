...
% Emap = snakeMap4e (f)  
    ...
    saveas(gcf, fullfile(pwd,'rose512_1'),'tif');
    ...
    EMAP = snakeMap4e(f,'auto');
    imwrite(EMAP, 'rose512_2.tif'); %Save the EMAP of image
    ...
    imwrite(EMAP, 'rose512_3.tif'); %Save the EMAP of image
    ...
    imwrite(EMAP, 'rose512_4.tif'); %Save the EMAP of image
    ...
    imwrite(EMAP, 'rose512_5.tif'); %Save the EMAP of image
    ...
    imwrite(EMAP, 'rose512_6.tif');%Save the EMAP of image
